                      ...
                      child: Stack(children: [
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(width * 0.025,
                              height * 0.035, width * 0.025, height * 0.025),
                          margin: const EdgeInsets.all(10),
                          decoration: BoxDecoration(
                              border: Border.all(
                                  color: const Color.fromRGBO(31, 212, 173, 1),
                                  width: 4)),
                          child: Image.asset(
                            'assets/images/expositores.jpeg',
                            fit: BoxFit.contain,
                          ),
                        ),
                        Positioned(
                          ...
                          child: Column(
                            children: [
                              ...
                              FilledButton(
                                  onPressed: () {
                                    html.window.open(
                                        'https://expotecnologia.manabi.gob.ec/resources/AGENDA_EXPO_TECNOLOGIA.pdf',
                                        "AGENDA");
                                  },
                                  child: const Text(
                                    "Descarga la agenda AQUI !",
